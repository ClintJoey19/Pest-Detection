...
const Features = () => {
  return (
    <div className="container grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
      ...
      <div className="bg-slate-100 rounded-xl col-span-2 flex flex-col gap-2 overflow-hidden">
      ...
      <div className="max-lg:order-first p-4 bg-white rounded-xl relative">
        <div className="absolute top-0 left-0 right-0 bottom-0 h-full flex items-center justify-center">
          <Image
            src="/logo.svg"
      ...
      <div className="p-4 bg-white rounded-xl lg:row-span-2 flex flex-col gap-2">
        <div className="relative w-full h-[250px] md:h-[300px] lg:h-[550px]">
          <Image
            src="/card-6.png"
            alt="ask-ai"
            fill
      ...
      <div className="p-4 bg-slate-100 rounded-xl col-span-2 relative overflow-hidden">
